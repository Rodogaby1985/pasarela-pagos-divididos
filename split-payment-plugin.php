 ...
 * Description:       Pasarela de pagos agregadora multi-procesador con segregación fiscal de envíos y totales. Conecta múltiples procesadores de pago (MercadoPago, Nave, Stripe, PayPal, etc.) para una experiencia de pago flexible y segura.
 * Version:           2.1.0
